...
class ActivitySelection(Select):
    ...
    async def callback(self, interaction: Interaction) -> WebhookMessage:
        ...
        try:
            ...
            return await interaction.warning(
...
class Interface(View):
    ...
    async def interaction_check(self, interaction: Interaction) -> bool:
        if not interaction.user.voice:
            await interaction.warning("You're not connected to a **voice channel**")
            return False
            ...
            await interaction.warning("You're not in a **VoiceMaster** channel!")
            return False
            ...
            await interaction.warning("You don't own a **voice channel**!")
            return False

        return True

    @button(
        emoji=config["emojis"]["interface"]["lock"],
    ...
    @button(
        emoji=config["emojis"]["interface"]["unlock"],
    ...
    async def ghost(self, interaction: Interaction, button: Button) -> WebhookMessage:
        ...
        return await interaction.success("Your **voice channel** has been hidden")

    @button(
        emoji=config["emojis"]["interface"]["reveal"],
    ...
    async def reveal(self, interaction: Interaction, button: Button) -> WebhookMessage:
        ...
        return await interaction.success("Your **voice channel** has been revealed")

    @button(
        emoji=config["emojis"]["interface"]["claim"],
    ...
    async def claim(self, interaction: Interaction, button: Button) -> WebhookMessage:
        ...
        return await interaction.success("You are now the owner of this **channel**!")
    ...
    @button(
        emoji=config["emojis"]["interface"]["information"],
    ...
    @button(
        emoji=config["emojis"]["interface"]["increase"],
    ...
    @button(
        emoji=config["emojis"]["interface"]["decrease"],
