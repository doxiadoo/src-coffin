...
class Help(commands.HelpCommand):
    async def send_bot_help(self, mapping):
        ...
        embed = discord.Embed(
            description=f"⚙️ {self.context.author.mention}: For help, visit our [website](https://{CONFIG['domain']}?prefix={urlencode(str(self.context.prefix))}) to view {total_commands} commands",
            color=CONFIG["colors"]["bleed"],
        )
