from discord.ext.commands import flag, Converter
...
class CollageFlags(FlagConverter):
	size: Optional[str] = flag(name = "size", default=None, description="a size in the form of height and width")
	time_period: Optional[TimePeriodConverter] = flag(name = "timeperiod", aliases = ["time", "timeframe"], default="overall", description = "the timeperiod of data to add to the collage")
	chart_type: Optional[ChartTypeConverter] = flag(name = "type", aliases = ["charttype"], default="artist", description = "the type of data to collage")
