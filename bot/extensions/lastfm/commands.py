...
#                "lastfm logout",
    ...
    @lastfm.command(
        name="login", description="Login and authenticate coffin to use your account"
    )
    ...
    async def lastfm_logout(self, ctx: Context):
        class ConfirmReset(discord.ui.View):
            ...
            async def approve(
                ...
                embed = Embed(
                    description=f"<:check:1286583241905803356> {interaction.user.mention}: Your account has been **removed**. Unauthorize [coffin](https://last.fm/settings/applications) here",
                    color=0x90DA68,
                )
