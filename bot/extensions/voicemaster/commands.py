...
class Voicemaster(Cog):
    ...
    async def voicemaster_setup(self, ctx: Context) -> Message:
        ...
        embed.add_field(
            name="**Button Usage**",
            value=(
                f"{config['emojis']['voicemaster']['lock']} — [`Lock`](https://coffin.bot/) the voice channel\n"
                f"{config['emojis']['voicemaster']['unlock']} — [`Unlock`](https://coffin.bot/) the voice channel\n"
                f"{config['emojis']['voicemaster']['ghost']} — [`Ghost`](https://coffin.bot/) the voice channel\n"
                f"{config['emojis']['voicemaster']['reveal']} — [`Reveal`](https://coffin.bot/) the voice channel\n"
                f"{config['emojis']['voicemaster']['claim']} — [`Claim`](https://coffin.bot/) the voice channel\n"
                f"{config['emojis']['voicemaster']['disconnect']} — [`Disconnect`](https://coffin.bot/) a member\n"
                f"{config['emojis']['voicemaster']['activity']} — [`Start`](https://coffin.bot/) an activity\n"
                f"{config['emojis']['voicemaster']['information']} — [`View`](https://coffin.bot/) channel information\n"
                f"{config['emojis']['voicemaster']['increase']} — [`Increase`](https://coffin.bot/) the user limit\n"
                f"{config['emojis']['voicemaster']['decrease']} — [`Decrease`](https://coffin.bot/) the user limit\n"
            ),
        )
